...
userSchema.virtual("profileBannerUrl").get(function () {
  ...
  return process.env.NODE_ENV === "production" ? "https://jconnect-server.onrender.com/img/profileBanners/".concat(this.profileBanner) : "img/profileBanners/".concat(this.profileBanner);
