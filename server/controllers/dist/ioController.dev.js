...
exports.createMessage = function _callee(io, socket, data) {
...
exports.inviteToGroupChat = function _callee3(io, socket, data) {
  ...
  return regeneratorRuntime.async(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 2:
          userConversation = _context3.sent;
...
exports.sendMessage = function _callee6(io, socket, data) {
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 2:
          ...
          _context6.next = 8;
          return regeneratorRuntime.awrap(Promise.all(data.images.map(function _callee4(img, idx) {
            var buffer, filename;
        ...
        case 15:
          updatedUserConversation = _context6.sent;
          ...
          _context6.next = 19;
          return regeneratorRuntime.awrap(Promise.all(newMessage.images.map(function _callee5(filename) {
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  ...
                  case 3:
                    ...
                    return _context5.abrupt("return", "data:image/jpeg;base64,".concat(buffer.toString("base64")));
        ...
        case 19:
          imageBase64Array = _context6.sent;
...
exports.reactToMesage = function _callee7(io, socket, data) {
...
exports.sendNotification = function _callee8(io, socket, data) {
  ...
  return regeneratorRuntime.async(function _callee8$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        ...
        case 23:
          _existingNotification = _context8.sent;
        ...
        case 34:
          newNotification = _context8.sent;
        ...
        case 44:
          ...
          console.log("Failed to create new notification:", _context8.t0);
