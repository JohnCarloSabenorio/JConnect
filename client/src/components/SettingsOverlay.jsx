...
export default function SettingsOverlay() {
  ...
  return (
    ...
    <div
      ...
      } absolute w-full h-full z-20 py-20 bg-black/70 justify-center items-center flex
        }`}
    >
      {/* Exit Button */}
      <svg
      ...
      {/* The card */}
      <div className="bg-white flex rounded-md w-full lg:max-w-150 overflow-hidden">
        {/* Settings Body */}
        {/* Settings option */}
        ...
        <div className="p-3 w-full">
          ...
          <div
            ...
            } bg-red-200 rounded-md p-6 w-full border-2 border-red-400`}
          >
            <ul>
