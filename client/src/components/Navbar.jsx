    ...
    <div className="bg-blue-800 flex justify-between p-2">
      ...
      <div className="flex gap-4 items-center mr-2 z-10">
        ...
        <button
          ...
          type="button"
          onClick={(e) => setMenuActive((prev) => !prev)}
        >
          <img
          ...
          <div
            ...
            } absolute top-full mt-3 right-0 rounded-sm w-50 bg-gray-50 shadow-lg origin-top duration-100 flex flex-col justify-start`}
          >
